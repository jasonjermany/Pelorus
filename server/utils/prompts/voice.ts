...
STEP 1: Does the submission explicitly confirm the condition is ABSENT?
  ...
  - Confirmation comes from a T1 or T2 source: named professional report, licensed inspection certificate, or explicit documented statement
...
STEP 2: Does the submission mention, describe, or imply this condition in any way?
  ...
  - Any document mentions the condition existed, even if claimed fixed, unless T1 professional certification of complete removal is included
  ...
  - Claimed remediation is stated but supporting T1/T2 documentation is absent
  - A T3 or T4 source claims the condition is absent but no T1/T2 confirms it
...
THE BRIGHT LINE:
  "fail"   = submission mentions or implies the condition but does not satisfy the requirement with T1/T2 documentation
...
TIEBREAKERS — when in doubt:
  ...
  "It was fixed" without T1/T2 supporting documentation:  "fail", not "review"
  ...
  T3 broker narrative denying the condition:              "fail" unless T1/T2 confirms
