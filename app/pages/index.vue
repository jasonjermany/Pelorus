<template>
  <div class="min-h-screen bg-surface-50 font-sans">
    ...
    <header class="sticky top-0 z-50 bg-primary-800 border-b border-white/5">
      ...
      >
        <div class="flex items-center gap-2.5">
          ...
          <span class="font-sans text-[19px] text-white tracking-[-0.3px]"
            >Pelorus</span
          >
        </div>
      ...
      >
        ...
        <div class="px-6 py-5 flex flex-col gap-4">
            ...
            >
              ...
              >
                <svg
                  ...
                  fill="none"
                  :class="
                    ingestFiles.length ? 'text-primary-800' : 'text-black/25'
                  "
                >
                  <path
          ...
          <div>
            <label
              ...
              >Broker email
              <span
                class="normal-case font-normal text-black/30 tracking-normal"
                >(optional)</span
              ></label
            >
            <input
        ...
        >
          ...
          <button
            ...
            :disabled="
              isIngesting || (!ingestFiles.length && !ingestText.trim())
            "
            @click="submitIngest"
          >
    ...
    <main class="mx-auto max-w-5xl px-8 py-10">
      ...
      <div
        class="bg-white rounded-2xl border border-black/[0.07] shadow-card overflow-scroll max-h-[90vh]"
      >
        <div
          ...
          >
            <div class="min-w-0 flex-1">
              ...
              <p class="mt-0.5 text-[12px] text-black/40">
                ...
                <span v-if="sub.broker && sub.prior_carrier" class="mx-1"
                  >·</span
                >
                <span v-if="sub.prior_carrier">{{ sub.prior_carrier }}</span>
                <span v-if="!sub.broker && !sub.prior_carrier">{{
            ...
            <div class="flex items-center gap-2.5 flex-shrink-0">
              ...
              >
                <span
                  class="inline-block w-3 h-3 border-2 border-accent-500/30 border-t-accent-500 rounded-full animate-spin"
                />
                Analyzing...
              </span>
              <span
...
async function submitIngest() {
  ...
  try {
    if (ingestFiles.value.length) {
      ...
      if (ingestBrokerEmail.value)
        fd.append("brokerEmail", ingestBrokerEmail.value);
